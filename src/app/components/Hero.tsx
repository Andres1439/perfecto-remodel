  ...
  return (
    <>
      ...
      <div className="pt-24 lg:pt-28">
        {" "}
        {/* Ajusta el padding-top para evitar superposición */}
        <div className="relative isolate px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl pb-5">
                Transform your home, transform your life
              </h1>
              <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-lg">
